...
open class SetTextFormatCommand(icon: ImageReference = AndroidImageReference(R.drawable.ic_text_format_white_48dp), protected var utils: TextFormatUtils = TextFormatUtils())

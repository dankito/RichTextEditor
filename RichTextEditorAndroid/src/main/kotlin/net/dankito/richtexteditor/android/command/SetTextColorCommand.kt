...
open class SetTextColorCommand(defaultColor: Color = Color.Black, icon: Icon = AndroidIcon(R.drawable.ic_format_color_text_white_48dp), showColorInCommandView: Boolean = true)

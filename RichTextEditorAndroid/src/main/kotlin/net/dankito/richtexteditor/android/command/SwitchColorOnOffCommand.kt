...
abstract class SwitchColorOnOffCommand(private val offColor: Color, private var onColor: Color, showColorInCommandView: Boolean = true, command: Command, icon: Icon, style: ToolbarCommandStyle = ToolbarCommandStyle(),

...
open class SetFontNameCommand(icon: ImageReference = AndroidImageReference(R.drawable.ic_font_download_white_48dp), protected var utils: FontNameUtils = FontNameUtils())

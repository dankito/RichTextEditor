...
class InsertNumberedListCommand(icon: ImageReference = JavaFXImageReference.fromIconsResourceName("ic_format_list_numbered_black_36dp.png")) : InsertNumberedListCommandBase(icon) {

...
open class SwitchTextBackgroundColorOnOffCommand(offColor: Color = Color.Transparent, onColor: Color = Color.Yellow, icon: Icon = JavaFXIcon.fromResourceName("ic_format_color_fill_black_36dp.png"),

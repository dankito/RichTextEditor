...
open class SuperscriptCommand(icon: ImageReference = JavaFXImageReference.fromIconsResourceName("ic_format_superscript_black_36dp.png")) : SuperscriptCommandBase(icon) {

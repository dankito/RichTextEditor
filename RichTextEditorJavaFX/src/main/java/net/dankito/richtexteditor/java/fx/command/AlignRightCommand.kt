...
open class AlignRightCommand(icon: ImageReference = JavaFXImageReference.fromIconsResourceName("ic_format_align_right_black_36dp.png")) : AlignRightCommandBase(icon) {

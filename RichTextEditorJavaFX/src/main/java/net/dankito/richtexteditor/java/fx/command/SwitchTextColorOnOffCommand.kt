...
open class SwitchTextColorOnOffCommand(offColor: Color = Color.Black, onColor: Color = Color.Red, icon: ImageReference = JavaFXImageReference.fromIconsResourceName("ic_format_color_text_black_36dp.png"),

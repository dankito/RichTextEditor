...
class AlignCenterCommand(icon: ImageReference = JavaFXImageReference.fromIconsResourceName("ic_format_align_center_black_36dp.png")) : AlignCenterCommandBase(icon) {

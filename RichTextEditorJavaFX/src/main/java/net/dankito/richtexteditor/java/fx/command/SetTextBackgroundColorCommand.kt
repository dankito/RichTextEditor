...
class SetTextBackgroundColorCommand(defaultColor: Color = Color.Transparent, icon: ImageReference = JavaFXImageReference.fromIconsResourceName("ic_format_color_fill_black_36dp.png"), showColorInCommandView: Boolean = true)

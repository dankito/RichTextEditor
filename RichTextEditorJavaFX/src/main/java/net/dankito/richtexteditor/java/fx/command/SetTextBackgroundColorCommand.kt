...
open class SetTextBackgroundColorCommand(defaultColor: Color = Color.Transparent, icon: Icon = JavaFXIcon.fromResourceName("ic_format_color_fill_black_36dp.png"), showColorInCommandView: Boolean = true)
